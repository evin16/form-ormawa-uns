    ...
    <div class="row justify-content-center gap-2">
        <div class="col-md col-sm">
            ...
            <div class="float-end my-3 gap-2">
                ...
                <button type="button" class="btn btn-primary btn float-end my-3" data-bs-toggle="modal"
                    data-bs-target="#details">
                    <i class="bi bi-plus-lg"></i>
                </button>
                @elseif ($targetproker->status == 'final')
                <a href="{{route('user.pdf', [$proker->id])}}" class="btn btn-primary btn" target="_blank">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if($targetproker->status == 'belum')
                    <button type="button" class="btn btn-primary btn-sm float-end rounded" data-bs-toggle="modal"
                    ...
                    <div class="modal fade" id="final" tabindex="-1">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{route('user.final', [$targetproker->id])}}" method="POST">
                                        @csrf
                                        @method('PATCH')
